        ...
        >
          ...
          <div className="w-full flex justify-center mt-6">
            <div className="flex w-[1136px] h-[80px] bg-white rounded-[10px] relative">
              {/* Search Input */}
              <div className="flex items-center text-dark-grey px-4 w-[834px] ">
              ...
              <div className="w-[302px] h-full ">
                <button
                  ...
                  className="flex items-center justify-between px-4 py-3 w-full text-dark-grey h-full cursor-pointer"
                >
                  <div className="flex gap-2 items-center">
                    <CiLocationOn className="text-headerxl" />
                  ...
                  <div className="absolute mt-1 w-[302px] bg-white border rounded shadow-md">
                    {locations.map((city) => (
                      <button
                        ...
                        className="w-full px-4 py-2 text-left hover:bg-gray-100 text-dark-grey"
                      >
                        {city}
                      </button>
                    ))}
      ...
      <div className="block md:hidden">
        <div className="w-full flex flex-col justify-center px-4 py-6">
          ...
          <div className="w-full flex justify-between items-center my-4">
            <p className="text-btn-color text-[28px] font-bold">Explore</p>
            <div className="flex items-center gap-0.5 text-primary-800">
              <CiLocationOn />
              <p className="text-sm font-normal">Victoria Island</p>
            </div>
          </div>
          <div className="flex w-full h-12 bg-[#FBFBFB] border border-neutral-white-50 rounded-md relative mb-4">
            {/* Search Input */}
            <div className="flex items-center text-dark-grey px-4 w-full">
              <FiSearch className="mr-2 text-lg" />
              <input
                type="text"
                placeholder="Search for events"
                className="w-full text-xs py-3 outline-none"
              />
            </div>
          </div>
        </div>
